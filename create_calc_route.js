...
// 1. API: src/app/api/calculate-price/route.ts
ensureDir(path.join(process.cwd(), 'src', 'app', 'api', 'calculate-price'));
const apiCalcRoute = `import { NextRequest, NextResponse } from 'next/server';
...
`;
fs.writeFileSync(path.join(process.cwd(), 'src', 'app', 'api', 'calculate-price', 'route.ts'), apiCalcRoute);

console.log('Calculation API route created successfully.');
