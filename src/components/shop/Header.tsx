          ...
          <div className="flex items-center gap-2 sm:gap-4 shrink-0">
            ...
            {currentUser ? (
              ...
              >
                <Link
                  href="/hesabim"
                  className="flex items-center gap-1.5 px-2.5 py-2 text-xs font-bold text-slate-800 hover:text-[#1B84F8] transition"
                >
                  <div className="w-5 h-5 rounded-full bg-[#1B84F8] text-white flex items-center justify-center text-[10px] font-black">
